...
await writeFile("build/habitat-embed.js", embedSource)
await writeFile("build/habitat-import.js", moduleSource)

//===============//
// Build Example //
//===============//
const exampleTags = [...paths.header, ...paths.middle, ...paths.footer].map(path => `<script src="../${path}"></script>`)
const exampleSource = `<!-- This file shows you how you can use the project by using multiple script tags that link directly to the source files. -->
